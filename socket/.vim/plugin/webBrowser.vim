...
"  let s:lynxPath = '/usr/local/etc/lynx.cfg'
"  let s:lynxExe = '/uar/local/bin' . 'lynx'
" "let s:lynxCfg = '-cfg=' .  . 'lynx.cfg'
"  let s:lynxCfg = '-cfg=' . s:lynxPath . 'lynx.cfg'
"  let s:lynxLss = '-lss=' . s:lynxPath . 'lynx.lss'
"  let s:lynxCmd = s:lynxExe . ' ' . s:lynxCfg . ' ' . s:lynxLss
"  let s:lynxDumpPath = '~/lynx/dump'
...
"let s:lynxToolsPath = 'c:\lynx\tools\'
  ...
  let s:lynxPath = '/usr/local/etc/'
  let s:lynxExe = '/uar/local/bin' . 'lynx'
  let s:lynxCfg = '-cfg=' . s:lynxPath . 'lynx.cfg'
  let s:lynxLss = '-lss=' . s:lynxPath . 'lynx.lss'
  let s:lynxCmd = s:lynxExe . ' ' . s:lynxCfg . ' ' . s:lynxLss

let g:WbLynxDumpPath = '/tmp/'
 " let s:lynxToolsPath = 'c:\lynx\tools'
