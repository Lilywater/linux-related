...
class InterfaceSpec(object):
    ...
    messages = {
        ...
        's11': {
			...
			'PGW Restart Notification' : 'pgwRestartNotification {',
			'PGW Restart Notification Acknowledge' : 'pgwRestartNotificationAck {',
            },
        'sgsn': {
        ...
        'sm': {
            'MBMS Session Start Request': 'mbmsSessionStartRequest {',           	
            'MBMS Session Start Response' : 'mbmsSessionStartResponse {',
            'MBMS Session Stop Request': 'mbmsSessionStopRequest {',           	
            'MBMS Session Stop Response' : 'mbmsSessionStopResponse {',
            'MBMS Session Update Request': 'mbmsSessionUpdateRequest {',           	
            'MBMS Session Update Response' : 'mbmsSessionUpdateResponse {',
            },
        'm3': {
            'M3 Setup Request': 'M3AP.M3SetupRequest {',           	
            'M3 Setup Response' : 'M3AP.M3SetupResponse {',
            'M3 Setup Failure' : 'M3AP.M3SetupFailure {',
            'M3 Session Start Request': 'M3AP.MBMSSessionStartRequest {',           	
            'M3 Session Start Response' : 'M3AP.MBMSSessionStartResponse {',
            'M3 Session Start Failure' : 'M3AP.MBMSSessionStartFailure {',
            'M3 Session Stop Request': 'M3AP.MBMSSessionStopRequest {',           	
            'M3 Session Stop Response' : 'M3AP.MBMSSessionStopResponse {',
            'M3 Session Update Request': 'M3AP.MBMSSessionUpdateRequest {',           	
            'M3 Session Update Response' : 'M3AP.MBMSSessionUpdateResponse {',
            'M3 Session Update Failure' : 'M3AP.MBMSSessionUpdateFailure {',
            'M3 Reset': 'M3AP.Reset {',           	
            'M3 Reset Acknowledge' : 'M3AP.ResetAcknowledge {',
            'MCE Configuration Update': 'M3AP.MCEConfigurationUpdate {',           	
            'MCE Configuration Update Acknowledge' : 'M3AP.MCEConfigurationUpdateAcknowledge {',
            'MCE Configuration Update Failure': 'M3AP.MCEConfigurationUpdateFailure {',     
            'Error Indication': 'M3AP.ErrorIndication {',   
            },
        }
