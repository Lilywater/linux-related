...
*** $ CTRl+R
type into the command, it will search the command for you

*** [!number][!command][!!]
there are number prefixed the history command
you can call the command use that number
!58
will echo "make a stamp in term a"
!commandname 
...
[root@TTCN9 test]# echo "AB"|xxd -g 1 |tee file
0000000: 41 42 0a                                         AB.
